...
class DetectronTrainedModel(ApiModel):
    @abc.abstractmethod
...
class DetectronFreezeModel(DetectronTrainedModel):
    ...
    def __init__(self, model: str, labels_map: str, config: dict):
        ...
        super(DetectronFreezeModel, self).__init__(labels_map, config)
        self._model = model

    def __enter__(self):
        print("[INFO] loading pre-trained model...")
        super(DetectronFreezeModel, self).__enter__()
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        super(DetectronFreezeModel, self).__exit__(exc_type, exc_val, exc_tb)
