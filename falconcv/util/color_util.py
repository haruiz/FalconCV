...
if __name__ == "__main__":
    colors_dict=ColorUtil.linear_gradient("#e2f442",n=32)
    R=colors_dict["r"]
    G=colors_dict["g"]
    B=colors_dict["b"]
    ...
    colors_dict=ColorUtil.polylinear_gradient(
    ...
    colors_dict=ColorUtil.rainbow(n=32)
    R=colors_dict["r"]
    G=colors_dict["g"]
    B=colors_dict["b"]
    gradient=list(zip(B,G,R))
